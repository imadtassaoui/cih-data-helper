...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      " px-3 py-2 text-base border border-slate-200 font-bold text-left align-top w-fit text-slate-500 [&:has([role=checkbox])]:pr-0 dark:text-gray-400",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <td
    ref={ref}
    className={cn(
      "px-3 py-2 text-base border-r border-s border-slate-200 align-top [&:has([role=checkbox])]:pr-0",
      className
    )}
    {...props}
  />
